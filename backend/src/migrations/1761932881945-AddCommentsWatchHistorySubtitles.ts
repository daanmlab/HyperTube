...
export class AddCommentsWatchHistorySubtitles1761932881945 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "comments" ADD CONSTRAINT "FK_10be931ad1a27b712ff61403882" FOREIGN KEY ("imdbId") REFERENCES "movies"("imdbId") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "watch_history" ADD CONSTRAINT "FK_380abb1bde1b1c59cc40cb75c83" FOREIGN KEY ("imdbId") REFERENCES "movies"("imdbId") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "subtitles" ADD CONSTRAINT "FK_aee32dd5178d33bb7f6d8e29b31" FOREIGN KEY ("imdbId") REFERENCES "movies"("imdbId") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
